...
def first_feature():
    ...
    * 顺序不要弄乱了。否则识别错误
    """
    return [
        ("POS1","TipGEBAF250A","Tips for Buffer A","",False,True,""),
        ("POS2","TipGEBAF250A","Tips for Buffer B","",False,True,""),
        ("POS3","","","",False,True,""),
        ("POS4","","","",False,True,""),
        ("POS5","","","",False,True,""),
        ("POS6","","","",False,True,""),
...
shake_choice = "n" #
incubation_time = 0 #
#Taking the variables from the user and changing the datatype to integer as necessary
s_require3_result = require3([],[{"number plates (8 max)":[""]},{"incubation time (min)":[""]},{"shake choice (y/n)":[""]}])
...
for plate in range(int(number_plates)):
    aspirate({"Module":"POS22","Tips":8,"Col":1,"Row":1,"AspirateVolume":100,"BottomOffsetOfZ":0.5,"AspirateRateOfP":100,"PreAirVolume":5,"PostAirVolume":0,"DelySeconds":0.5,"IfTipTouch":True,"TipTouchHeight":10,"TipTouchOffsetOfX":3,"SecondRouteRate":10})
    dispense({"Module":cells_list[plate],"Tips":8,"Col":target_standard_curve_column_list[0],"Row":1,"DispenseVolume":30,"BottomOffsetOfZ":10,"DispenseRateOfP":100,"DelySeconds":0.5,"IfTipTouch":True,"TipTouchHeight":10,"TipTouchOffsetOfX":3,"SecondRouteRate":10,"EmptyForDispense":False,"EmptyForDispenseOffsetOfZ":10,"EmptyForDispenseDely":0.5})
    dispense({"Module":cells_list[plate],"Tips":8,"Col":target_standard_curve_column_list[1],"Row":1,"DispenseVolume":30,"BottomOffsetOfZ":10,"DispenseRateOfP":100,"DelySeconds":0.5,"IfTipTouch":True,"TipTouchHeight":10,"TipTouchOffsetOfX":3,"SecondRouteRate":10,"EmptyForDispense":False,"EmptyForDispenseOffsetOfZ":10,"EmptyForDispenseDely":0.5})
    dispense({"Module":cells_list[plate],"Tips":8,"Col":target_standard_curve_column_list[2],"Row":1,"DispenseVolume":30,"BottomOffsetOfZ":10,"DispenseRateOfP":100,"DelySeconds":0.5,"IfTipTouch":True,"TipTouchHeight":10,"TipTouchOffsetOfX":3,"SecondRouteRate":10,"EmptyForDispense":False,"EmptyForDispenseOffsetOfZ":10,"EmptyForDispenseDely":0.5})
    empty({"Module":"POS22","Tips":8,"Col":1,"Row":1,"BottomOffsetOfZ":35,"DispenseRateOfP":100,"DelySeconds":0.5,"IfTipTouch":True,"TipTouchHeight":1,"TipTouchOffsetOfX":0,"SecondRouteRate":10})
...
#buffer_a_counter = 0
for plate in range(int(number_plates)):
    aspirate({"Module":"POS23","Tips":96,"Col":1,"Row":1,"AspirateVolume":70,"BottomOffsetOfZ":0.5,"AspirateRateOfP":100,"PreAirVolume":5,"PostAirVolume":0,"DelySeconds":0.5,"IfTipTouch":True,"TipTouchHeight":35,"TipTouchOffsetOfX":5,"SecondRouteRate":10})
    dispense({"Module":cells_list[plate],"Tips":96,"Col":1,"Row":1,"DispenseVolume":60,"BottomOffsetOfZ":10,"DispenseRateOfP":100,"DelySeconds":0.5,"IfTipTouch":True,"TipTouchHeight":10,"TipTouchOffsetOfX":3,"SecondRouteRate":10,"EmptyForDispense":False,"EmptyForDispenseOffsetOfZ":10,"EmptyForDispenseDely":0.5})
...
#buffer_b_counter = 0
for plate in range(int(number_plates)):
    aspirate({"Module":"POS24","Tips":96,"Col":1,"Row":1,"AspirateVolume":70,"BottomOffsetOfZ":0.5,"AspirateRateOfP":100,"PreAirVolume":5,"PostAirVolume":0,"DelySeconds":0.5,"IfTipTouch":True,"TipTouchHeight":30,"TipTouchOffsetOfX":3,"SecondRouteRate":10})
    dispense({"Module":cells_list[plate],"Tips":96,"Col":1,"Row":1,"DispenseVolume":60,"BottomOffsetOfZ":10,"DispenseRateOfP":100,"DelySeconds":0.5,"IfTipTouch":True,"TipTouchHeight":10,"TipTouchOffsetOfX":3,"SecondRouteRate":10,"EmptyForDispense":False,"EmptyForDispenseOffsetOfZ":10,"EmptyForDispenseDely":0.5})
    empty({"Module":"POS24","Tips":96,"Col":1,"Row":1,"BottomOffsetOfZ":35,"DispenseRateOfP":1000,"DelySeconds":0.5,"IfTipTouch":True,"TipTouchHeight":1,"TipTouchOffsetOfX":5,"SecondRouteRate":10})
